...
public class DuelMenuController {
    ...
    public String startTwoPlayer(User currentUser, String secondPlayer, String rounds, String token) throws CloneNotSupportedException {
        //Game game = new Game();
        //assert game != null;
        ...
        phaseController.startTheGame(token);
        return "";
    }

    public String startSinglePlayer(User currentUser, String rounds, String difficulty, String token) throws CloneNotSupportedException {
        if (currentUser.getActiveDeck() == null)
            return currentUser.getUserName() + " has no active deck";
        if (!currentUser.getActiveDeck().isDeckValid())
            return currentUser.getUserName() + "'s deck is invalid";
        ...
        if (difficulty.equals("easy"))
            ...
            new HardBot(player);
        gameController.startTheGame(token);
        return "";
    }
}
